...
export interface Config {
  ...
  jobs: {
    tasks: {
      cloudflarePurgeTask: TaskCloudflarePurgeTask;
      inline: {
        input: unknown;
        output: unknown;
      };
...
export interface PayloadJob {
  ...
  log?:
    | {
        executedAt: string;
        completedAt: string;
        taskSlug: 'inline' | 'cloudflarePurgeTask';
        taskID: string;
        input?:
          | {
              [k: string]: unknown;
    ...
    | null;
  taskSlug?: ('inline' | 'cloudflarePurgeTask') | null;
  queue?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskCloudflarePurgeTask".
 */
export interface TaskCloudflarePurgeTask {
  input: {
    urls?:
      | {
          url?: string | null;
